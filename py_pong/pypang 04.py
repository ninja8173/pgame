...
character_y_pos = screen_heigh - stage_height - character_height
...
while running:
    ...
    for ball_idx, ball_one in enumerate(balls):
        ...
        # 공 새로 위치 확인
        if ball_pos_y > screen_heigh - stage_height - ball_height:
    ...
    screen.blit(stage, (0, screen_heigh - stage_height))
